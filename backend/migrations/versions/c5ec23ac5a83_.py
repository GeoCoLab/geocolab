...
Revision ID: c5ec23ac5a83
Revises: 
Create Date: 2021-10-09 13:39:38.560505
...
def upgrade():
    ...
    sa.Column('will_fund_travel', sa.Boolean(), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('able_to_travel', sa.Boolean(), nullable=False),
    sa.Column('fund_own_travel', sa.Boolean(), nullable=False),
